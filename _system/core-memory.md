...
- **AI Memory Vault**：Obsidian + RAG 個人第二大腦，Python 引擎 v2.2，LINE Bot 已串接
...
- Phase 3 進行中：Hybrid Search ✅、Auto-sync ✅、Recency Bias ✅、Core Memory ✅
- 下一步：.cs/.lua 程式碼索引、MCP Server

## 重要決策記錄

- 2026.03.28：Embedding 改用 multilingual-MiniLM-L12-v2（多語言支援）
- 2026.03.28：Vault 目錄扁平化，life/ 移除空殼子目錄
- 2026.03.28：公司資料夾改名 LIFEOFDEVELOPMENT（移除空格）
