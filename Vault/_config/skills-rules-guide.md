...
| 技能包 | Domain | 適用 Agent |
|--------|--------|-----------|
| `VaultWriteConventions_Skill.md` | vault-workflow | 全體 |
| `Debug_Skill.md` | debugging | Architect, CodeReviewer, BuildErrorResolver |
| `ApiMap_Skill.md` | documentation | DocUpdater, Architect |
